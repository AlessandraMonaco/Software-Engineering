 ...
 * 
 */
@WebServiceClient(name = "WSImplService", targetNamespace = "http://professor_soapserver.mycompany.com/", wsdlLocation = "http://localhost:7777/WSInterface?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSIMPLSERVICE_QNAME = new QName("http://professor_soapserver.mycompany.com/", "WSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7777/WSInterface?wsdl");
    ...
    public WSInterface getWSImplPort() {
        return super.getPort(new QName("http://professor_soapserver.mycompany.com/", "WSImplPort"), WSInterface.class);
    }
    ...
    public WSInterface getWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://professor_soapserver.mycompany.com/", "WSImplPort"), WSInterface.class, features);
    }
