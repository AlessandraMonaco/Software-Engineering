 ...
 * 
 */
@WebServiceClient(name = "WSImplService", targetNamespace = "http://movie_soapws.mycompany.com/", wsdlLocation = "http://localhost:7777/WSInterface?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSIMPLSERVICE_QNAME = new QName("http://movie_soapws.mycompany.com/", "WSImplService");
    ...
    public WSInterface getWSImplPort() {
        return super.getPort(new QName("http://movie_soapws.mycompany.com/", "WSImplPort"), WSInterface.class);
    }
    ...
    public WSInterface getWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://movie_soapws.mycompany.com/", "WSImplPort"), WSInterface.class, features);
    }
